...
export const UsdcIcon = ({ size = 24, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 120 120" className={className} style={style}>
...
export const EurcIcon = ({ size = 24, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 120 120" className={className} style={style}>
    <path fill="#0B53BF" d="M60 120c33.137 0 60-26.863 60-60S93.137 0 60 0 0 26.863 0 60s26.863 60 60 60"></path>
...
export const CirBtcIcon = ({ size = 24, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 24 24" className={className} style={style}>
...
export const ArcTestnetIcon = ({ size = 20, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 48 48" className={className} style={style}>
...
export const EthereumSepoliaIcon = ({ size = 20, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 120 120" className={className} style={style}>
...
export const ArbitrumSepoliaIcon = ({ size = 20, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 120 120" className={className} style={style}>
...
export const BaseSepoliaIcon = ({ size = 20, className = '', style = {} }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 120 120" className={className} style={style}>
...
export const TokenIcon = ({ symbol, size = 20, className = '', style = {} }) => {
  const sym = String(symbol || '').toUpperCase();
  if (sym.includes('USDC')) return <UsdcIcon size={size} className={className} style={style} />;
  if (sym.includes('EURC')) return <EurcIcon size={size} className={className} style={style} />;
  if (sym.includes('BTC') || sym.includes('CIRBTC')) return <CirBtcIcon size={size} className={className} style={style} />;
  return null;
};

export const NetworkIcon = ({ name, size = 20, className = '', style = {} }) => {
  const n = String(name || '').toLowerCase();
  if (n.includes('arc')) return <ArcTestnetIcon size={size} className={className} style={style} />;
  if (n.includes('ethereum') || n.includes('sepolia') || n === 'eth') {
    if (n.includes('base')) return <BaseSepoliaIcon size={size} className={className} style={style} />;
    if (n.includes('arbitrum')) return <ArbitrumSepoliaIcon size={size} className={className} style={style} />;
    return <EthereumSepoliaIcon size={size} className={className} style={style} />;
  }
  if (n.includes('arbitrum') || n.includes('arb')) return <ArbitrumSepoliaIcon size={size} className={className} style={style} />;
  if (n.includes('base')) return <BaseSepoliaIcon size={size} className={className} style={style} />;
  return null;
};
